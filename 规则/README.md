...
| `04-下载分级规则.md` | 五种下载策略、样例公开、历史版本、codebook/对照表、单独授权到期、下载申请审批、留痕 | `api/datasets.py`(`check_download`) |
...
| `07-消息中心与邮件提醒规则.md` | 消息分类与红点、轮询、每日摘要邮件 | `api/notifications.py`、`services/digest.py` |
